...
public class WaveDrawable2 extends Drawable implements Animatable, ValueAnimator.AnimatorUpdateListener {
    ...
    public WaveDrawable2(int color) {
        init();
        mColor = color;
    }
    ...
    private void updateMask(int width, int length, int height) {
        ...
        int totalHeight = mHeight + height;

        Bitmap bm = Bitmap.createBitmap(length * count, totalHeight, Bitmap.Config.ARGB_8888);
        ...
        path.lineTo(bm.getWidth(), totalHeight);
